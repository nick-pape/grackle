...
describe("session_attach", () => {
  ...
  // Scoped-auth ancestry / taskless-session enforcement for session_attach moved
  // to the central dispatcher (enforceToolScope); see scope-enforcement.test.ts
  // and mcp-server.test.ts.
});
...
describe("session_send_input", () => {
  ...
  // Scoped-auth ancestry / taskless-session enforcement for session_send_input
  // moved to the central dispatcher (enforceToolScope); see
  // scope-enforcement.test.ts and mcp-server.test.ts.
});
