...
- `/test-codex-runtime` — `codex` (use `gpt-5.5`; needs SDK >= 0.135.0)
- `/test-acp-runtime` — `claude-code-acp` / `codex-acp` / `copilot-acp` (claude-code-acp validated; surfaces real tool failures native claude-code can't)
